...
client : client.o fileIO.o sockets.o
	cc $(CFLAGS) client.o fileIO.o sockets.o -o client

gstat : gstat.o ipc.o
	cc $(CFLAGS) gstat.o ipc.o -o gstat

maint : maint.o ipc.o
	cc $(CFLAGS) maint.o ipc.o -o gstat

server : server.o fileIO.o sockets.o ipc.o
	cc $(CFLAGS) server.o fileIO.o sockets.o ipc.o -o server
